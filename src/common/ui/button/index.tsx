    ...
    return (
      ...
      >
        ...
        <span className="absolute inset-0 z-10 flex items-center justify-center">
          <span
            className={cn(
              "inline-flex h-full items-center justify-center gap-2 leading-none transition-[opacity,transform] duration-150 ease-out",
          ...
          <span
            className={cn(
              "absolute inset-0 grid place-items-center transition-[opacity,transform] duration-150 ease-out",
